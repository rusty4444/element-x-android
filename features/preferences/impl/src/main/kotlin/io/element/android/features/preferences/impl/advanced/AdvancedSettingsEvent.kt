...
sealed interface AdvancedSettingsEvent {
    ...
    data class SetAccentColor(val accentColor: AccentColorOption) : AdvancedSettingsEvent
    data class SetShowEncryptionWarning(val enabled: Boolean) : AdvancedSettingsEvent
