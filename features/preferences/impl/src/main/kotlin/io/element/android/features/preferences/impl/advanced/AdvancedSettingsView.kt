    ...
    PreferencePage(
        ...
        PreferenceDropdown(
            ...
            onSelectOption = { accentOption ->
                state.eventSink(AdvancedSettingsEvent.SetAccentColor(accentOption))
            }
        )
        ListItem(
            content = {
        ...
        ListItem(
            ...
            onClick = { state.eventSink(AdvancedSettingsEvent.SetShowEncryptionWarning(!state.isShowEncryptionWarningEnabled)) }
        )
